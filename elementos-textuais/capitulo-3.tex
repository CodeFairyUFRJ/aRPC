...
\includecode[Go]{Código gerado pelo compilador do aRPC para o cliente de um serviço simples} {alg:arpc_compiler_client.go}{codigos/compilador/client.go}{}

\includecode[Go]{Código gerado pelo compilador do aRPC para o servidor de um serviço simples} {alg:arpc_compiler_server.go}{codigos/compilador/server.go}{}
...
\includecode[Go]{Exemplo de IDL usada pelo compilador do aRPC para definição de um serviço simples} {alg:arpc_compiler_idl.go}{codigos/compilador/idl.arpc.go}{}
